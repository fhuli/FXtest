RegisterServerEvent('rental:CheckMoneyForVel')

AddEventHandler('rental:CheckMoneyForVel', function(name, vehicle, price)
  local source = source
  TriggerEvent('es:getPlayerFromId', source, function(user)
    ...
    local price = tonumber(price)
        ...
        if (tonumber(user.getMoney()) >= tonumber(price)) then
          ...
          TriggerClientEvent('rental:FinishMoneyCheckForVel', source, name, vehicle, price)
