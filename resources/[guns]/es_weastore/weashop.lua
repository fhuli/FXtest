	...
	menu = {
		...
		["main"] = {
			...
			buttons = {
				...
				{title = "Utilities", name = "Utilities", description = ""},
			}
		},
		["Melee"] = {
			title = "Melee weapons",
			name = "Melee",
			buttons = {
				{title = "Knife", name = "Knife", costs = 200, description = {}, model = "WEAPON_Knife"},
				--{title = "Nightstick", name = "Nightstick", costs = 25000, description = {}, model = "WEAPON_Nightstick"},
				{title = "Hammer", name = "Hammer", costs = 10, description = {}, model = "WEAPON_HAMMER"},
				{title = "Bat", name = "Bat", costs = 80, description = {}, model = "WEAPON_Bat"},
				{title = "Crowbar", name = "Crowbar", costs = 100, description = {}, model = "WEAPON_Crowbar"},
				{title = "Golfclub", name = "Golfclub", costs = 150, description = {}, model = "WEAPON_Golfclub"},
				--{title = "Bottle", name = "Bottle", costs = 120000, description = {}, model = "WEAPON_Bottle"},
				{title = "Dagger", name = "Dagger", costs = 500, description = {}, model = "WEAPON_Dagger"},
				{title = "Hatchet", name = "Hatchet", costs = 400, description = {}, model = "WEAPON_Hatchet"},
				...
				{title = "SwitchBlade", name = "SwitchBlade", costs = 500, description = {}, model = "WEAPON_SwitchBlade"},
		...
		["Pistols"] = {
			...
			name = "Pistols",
			buttons = {
				{title = "Pistol", name = "Pistol", costs = 1750, description = {}, model = "WEAPON_Pistol"},
				{title = "Combat Pistol", name = "CombatPistol", costs = 3250, description = {}, model = "WEAPON_CombatPistol"},
				--{title = "Pistol Cal 50", name = "Pistol50", costs = 3000, description = {}, model = "WEAPON_PISTOL50"},
				{title = "SNS Pistol", name = "SNSPistol", costs = 1000, description = {}, model = "WEAPON_SNSPistol"},
		...
		["Utilities"] = {
			...
			name = "Utilities",
			buttons = {
				{title = "Flare", name = "Flare", costs = 500, description = {}, model = "WEAPON_Flare"},
				{title = "Flare Gun", name = "FlareGun", costs = 800, description = {}, model = "WEAPON_FlareGun"},
				{title = "Flashlight", name = "Flashlight", costs = 50, description = {}, model = "WEAPON_Flashlight"},
				...
				{title = "Petrol Can", name = "PetrolCan", costs = 5000, description = {}, model = "WEAPON_PetrolCan"},
				{title = "Fire Extinguisher", name = "FireExtinguisher", costs = 1500, description = {}, model = "WEAPON_FireExtinguisher"},
			...
			while #weashop_blips > 0 do
				...
				for i,b in ipairs(weashop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and weashop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 2 then
						...
						drawTxt('Press ~g~ENTER~s~ to open ~b~gun store',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
