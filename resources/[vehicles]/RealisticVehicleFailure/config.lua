...
cfg = {
	...
	damageFactorEngine = 6.0,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	damageFactorBody = 8.0,					-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 10
	...
	degradingHealthSpeedFactor = 6,			-- Speed of slowly degrading health, but not failure. Value of 10 means that it will take about 0.25 second per health point, so degradation from 800 to 305 will take about 2 minutes of clean driving. Higher values means faster degradation
...
repairCfg = {
	...
	fixMessages = {
		"You turn the key",
		"You punch the dashboard",
		"You turn the key, and pump the accelerator"
	},
	fixMessageCount = 3,

	noFixMessages = {
		"You turned the key, nothing happens",
		"You watch the smoke pour out of your hood, the engine wont start",
		"You punch the dashboard and turn the key, nothing happens"
	},
	noFixMessageCount = 3
}
