...
function Global.AddAMarkerOverVehicle(vehicle)
...
function Global.BadSportPlayerLeftDetected(p1, p2)
...
function Global.EnableDispatchService(dispatchType, toggle)
...
function Global.GetEventAtIndex(p0, p1)
...
function Global.N_0x40cf0d12d142a9e8(ped)
...
function Global.N_0x49b99bf3fda89a7a(ped, speechName, unk)
...
function Global.N_0x4ada3f19be4a6047(ped)
...
function Global.N_0x7a73d05a607734c7(ped)
...
function Global.N_0x9a83f5f9963775ef(vehicle)
...
function Global.N_0xacb5dcca1ec76840(vehicle)
	return _in(0xACB5DCCA1EC76840, vehicle, _r, _ri)
end

function Global.N_0xad2d28a1afdff131(vehicle, p1)
	return _in(0xAD2D28A1AFDFF131, vehicle, p1)
end
...
function Global.N_0xc819f3cbb62bf692(render, p1, p2)
...
function Global.N_0xe301bd63e9e13cf0(cargobob, vehicle)
...
function Global.NetworkIsFriendInMultiplayer(networkHandle)
	return _in(0x57005C18827F3A28, _ii(networkHandle) --[[ may be optional ]], _r)
end

function Global.NetworkIsFriendInSameTitle(networkHandle)
...
function Global.NetworkShopIsItemUnlocked(name)
	return _in(0xBD4D7EAF8A30F637, _ts(name), _r)
end

function Global.NetworkShopIsItemUnlockedHash(hash)
...
function Global.NewLoadSceneStartSphere(p0, p1, p2, p3, p4)
...
function Global.SetAiBlipMaxDistance(ped, p1)
	return _in(0x97C65887D4B37FA9, ped, p1)
end
...
function Global.SetCargobobHookPosition(p0, p1, p2, p3)
...
function Global.SetEntityRegister(entity, toggle)
...
function Global.SetMpGamerTagHealthBarColor(headDisplayId, color)
