...
local helishop = {
	...
	menu = {
		...
		["Hélicoptères"] = {
			...
			name = "Hélicoptères",
			buttons = {
				{name = "Super Volito", costs = 10, description = {}, model = "supervolito"},
                                {name = "Super Volito 2", costs = 10, description = {}, model = "supervolito2"},
                                {name = "Volatus", costs = 10, description = {}, model = "volatus"},
                                {name = "Swift", costs = 10, description = {}, model = "swift"},
                                {name = "Swift 2", costs = 10, description = {}, model = "swift2"},
			}
		},
	}
}
...
function Back()
	...
	elseif helishop.currentmenu == "Hélicoptères" then
			...
			for i,button in pairs(menu.buttons) do
				if i >= helishop.menu.from and i <= helishop.menu.to then
					...
					if button.costs ~= nil then
						...
						if helishop.currentmenu == "Hélicoptères" then
